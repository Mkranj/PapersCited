...
main_window.rowconfigure(0, weight = 0, minsize = 50)
main_window.rowconfigure(1, weight = 2, minsize = 400)
main_window.rowconfigure(2, weight = 0, minsize = 50)
...
lbl_current_file.grid(row = 0, column = 1, columnspan = 3, sticky = "NWE")
