...
def test_detecting_single_authors():
    ...
    assert PapersCited.detect_one_author(test_string_and).citations ==\
...
def test_detecting_author_et_al():
    ...
    assert PapersCited.detect_author_et_al(test_string_semicolon) ==\
        ["Truth et al. 1980"]
